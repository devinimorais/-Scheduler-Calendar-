...
const Services = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      toast.success(`Serviço confirmado para o dia ${selectedDate} às ${selectedTimeSlot}!`);
      closeModal();
      ...
      <div className="p-6 lg:p-8 mt-16">
        ...
        <div className="flex justify-end items-center mb-8">
          <input
            ...
            className="w-full lg:w-1/5 p-3 border border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-teal-500"
            value={searchTerm}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredServices.map((service) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-2">Duração: {service.duration} min</p>
              <p className="text-lg font-bold text-green-300 mb-4">R$ {service.price}</p>
              <p className="text-sm text-gray-300 text-center mb-4">{service.description}</p>
              <button
                className="w-full py-3 rounded-full bg-white text-black font-semibold hover:bg-gray-300"
